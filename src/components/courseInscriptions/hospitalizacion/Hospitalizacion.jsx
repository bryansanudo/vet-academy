...
import HospitalizacionLayout from "@/components/courseInscriptions/hospitalizacion/HospitalizacionLayout";

import Inscriptions from "@/components/courseInscriptions/hospitalizacion/Inscriptions";
    ...
    <>
      ...
      >
        <div className={`${styles.boxWidth}`}>
          ...
          <HospitalizacionLayout darkMode={darkMode} />
        </div>
      </div>
    </>
  );
