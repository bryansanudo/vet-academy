...
import MobileInscriptions from "@/components/courseInscriptions/paciente/MobileInscriptions";

import StudyPlan from "@/components/courseInscriptions/paciente/StudyPlan";

const PacienteContent = ({ darkMode }) => (
  <section
    id="clients"
  ...
  >
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
      <h2 className={styles.heading2}>Paciente Crítico</h2>
