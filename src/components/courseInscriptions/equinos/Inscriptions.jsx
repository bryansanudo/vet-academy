  ...
  return (
    ...
    >
      <figure className="relative">
        <img src={curso14} className=" object-contain" alt="Shoes" />
      </figure>
            ...
            {language === "en" ? (
              <div className="flex flex-col">
                <div className="flex  gap-2 items-end justify-center">
                  <span className="text-primary ">Hasta Marzo 19 - $180</span>
                </div>
                <div className="flex  gap-2 items-end justify-center">
                  <span className="text-primary ">Hasta Abril 16 - $250</span>
                </div>
                <div className="flex  gap-2 items-end justify-center">
                  <span className="text-primary ">Hasta Mayo 5 - $300</span>
                </div>
              </div>
            ) : language === "es" ? (
              <div className="flex flex-col">
                <div className="flex  gap-2 items-end justify-center">
                  <span className="text-primary ">
                    Hasta Marzo 19 - $700.000
                  </span>
                </div>
                <div className="flex  gap-2 items-end justify-center">
                  <span className="text-primary ">
                    Hasta Abril 16 - $900.000
                  </span>
                </div>
                <div className="flex  gap-2 items-end justify-center">
                  <span className="text-primary ">
                    Hasta Mayo 5 - $1.000.000
                  </span>
                </div>
              </div>
            ) : (
