...
import MobileInscriptions from "@/components/courseInscriptions/etologia/MobileInscriptions";

import StudyPlan from "@/components/courseInscriptions/etologia/StudyPlan";

const EtologiaContent = ({ darkMode }) => (
  <section
    id="clients"
  ...
  >
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
      <h2 className={styles.heading2}>Curso Etología en la clínica diaria</h2>
...
export default EtologiaContent;
