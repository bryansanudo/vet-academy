...
import EtologiaLayout from "@/components/courseInscriptions/etologia/EtologiaLayout";

import Inscriptions from "@/components/courseInscriptions/etologia/Inscriptions";
import { useEffect } from "react";

const Etologia = ({ darkMode }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  return (
    <>
      ...
      >
        <div className={`${styles.boxWidth}`}>
          ...
          <EtologiaLayout darkMode={darkMode} />
        </div>
      </div>
    </>
  );
