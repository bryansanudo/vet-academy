...
import MobileInscriptions from "@/components/courseInscriptions/oncologia/MobileInscriptions";

import StudyPlan from "@/components/courseInscriptions/oncologia/StudyPlan";

const OncologiaContent = ({ darkMode }) => (
  <section
    id="clients"
  ...
  >
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
      <h2 className={styles.heading2}>Curso Oncología</h2>
...
export default OncologiaContent;
