...
import EnfermeriaLayout from "@/components/courseInscriptions/enfermeria/EnfermeriaLayout";

import Inscriptions from "@/components/courseInscriptions/enfermeria/Inscriptions";
    ...
    <>
      ...
      >
        <div className={`${styles.boxWidth}`}>
          ...
          <EnfermeriaLayout darkMode={darkMode} />
        </div>
      </div>
    </>
  );
