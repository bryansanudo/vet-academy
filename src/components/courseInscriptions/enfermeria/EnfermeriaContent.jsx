...
import MobileInscriptions from "@/components/courseInscriptions/enfermeria/MobileInscriptions";

import StudyPlan from "@/components/courseInscriptions/enfermeria/StudyPlan";

const EnfermeriaContent = ({ darkMode }) => (
  <section
    id="clients"
  ...
  >
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
      <h2 className={styles.heading2}>Curso Enfermería</h2>
...
export default EnfermeriaContent;
