...
import MobileInscriptions from "@/components/courseInscriptions/mascotas/MobileInscriptions";

import StudyPlan from "@/components/courseInscriptions/mascotas/StudyPlan";

const MascotasContent = ({ darkMode }) => (
  <section
    id="clients"
  ...
  >
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
      <h2 className={styles.heading2}>Mascotas Exóticas</h2>
...
export default MascotasContent;
