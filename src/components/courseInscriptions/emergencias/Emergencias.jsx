...
import EmergenciasLayout from "@/components/courseInscriptions/emergencias/EmergenciasLayout";

import Inscriptions from "@/components/courseInscriptions/emergencias/Inscriptions";
import { useEffect } from "react";

const Emergencias = ({ darkMode }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  return (
    <>
      ...
      >
        <div className={`${styles.boxWidth}`}>
          ...
          <EmergenciasLayout darkMode={darkMode} />
        </div>
      </div>
    </>
  );
