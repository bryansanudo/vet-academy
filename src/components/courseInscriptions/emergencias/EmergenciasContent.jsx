...
import MobileInscriptions from "@/components/courseInscriptions/emergencias/MobileInscriptions";

import StudyPlan from "@/components/courseInscriptions/emergencias/StudyPlan";

const EmergenciasContent = ({ darkMode }) => (
  <section
    id="clients"
  ...
  >
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
      <h2 className={styles.heading2}>Emergencias Veterinarias</h2>
...
export default EmergenciasContent;
